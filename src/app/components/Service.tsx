            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 p-4 bg-black bg-opacity-50 transition-all duration-300">
                  <h3
                    className="absolute bottom-4 left-6 text-6xl text-gray-100 uppercase drop-shadow-lg transition-all duration-500 ease-in-out transform group-hover:left-[-150%] origin-left whitespace-nowrap text-left"
                  ...
                  <p className="absolute opacity-0 group-hover:opacity-100 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity duration-500 ease-in-out text-white text-center text-4xl">
                    {service.description}
                  </p>
                </div>
              </div>
